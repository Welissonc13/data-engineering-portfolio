...
dirbase_input = r"C:\Users\User\Desktop\gestao\raw\862"
dirbase_output = r"C:\Users\User\Desktop\gestao\excel_convertido\862"
...
try:
        ...
        print("Conversão do relatório 862 completa!")
        
except:
    print("Não foi possível realizar a conversão do relatório 862.")