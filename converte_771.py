...
dirbase_input = r"C:\Users\User\Desktop\gestao\raw\771"
dirbase_output = r"C:\Users\User\Desktop\gestao\excel_convertido\771"
...
try:
        ...
        print("Conversão do relatório 771 completa!")
        
except:
    print("Não foi possível realizar a conversão do relatório 771.")