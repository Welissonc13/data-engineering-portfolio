...
dirbase_input = r"C:\Users\User\Desktop\gestao\raw\740"
dirbase_output = r"C:\Users\User\Desktop\gestao\excel_convertido\740"
...
try:
        ...
        print("Conversão do relatório 740 completa!")
        
except:
    print("Não foi possível realizar a conversão do relatório 740.")